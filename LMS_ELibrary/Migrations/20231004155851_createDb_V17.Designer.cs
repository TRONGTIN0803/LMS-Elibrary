...
namespace LMS_ELibrary.Migrations
{
    ...
    [Migration("20231004155851_createDb_V17")]
    partial class createDb_V17
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS_ELibrary.Data.File_Baigiang_Db", b =>
                {
                    b.Property<int>("File_Baigiang_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("File_Baigiang_Id"), 1L, 1);
                    ...
                    b.HasKey("File_Baigiang_Id");

                    b.HasIndex("Baigiang_id");

                    b.HasIndex("Nguoitailen_Id");

                    b.ToTable("File_Baigiang");
                });
            ...
            modelBuilder.Entity("LMS_ELibrary.Data.File_Tainguyen_Db", b =>
                {
                    b.Property<int>("File_Tainguyen_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("File_Tainguyen_Id"), 1L, 1);
                    ...
                    b.HasKey("File_Tainguyen_Id");

                    b.HasIndex("Baigiang_Id");

                    b.HasIndex("Nguoitailen_Id");

                    b.ToTable("File_Tainguyen");
                });
            ...
            modelBuilder.Entity("LMS_ELibrary.Data.File_Baigiang_Db", b =>
                {
                    b.HasOne("LMS_ELibrary.Data.Tailieu_Baigiang_Db", "Baigiang")
                        .WithMany("list_File_Baigiang")
                        .HasForeignKey("Baigiang_id")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_file_baigiang");
            ...
            modelBuilder.Entity("LMS_ELibrary.Data.File_Tainguyen_Db", b =>
                {
                    b.HasOne("LMS_ELibrary.Data.Tailieu_Baigiang_Db", "Baigiang")
                        .WithMany("list_File_Tainguyen")
                        .HasForeignKey("Baigiang_Id")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_file_tainguyen");

                    b.HasOne("LMS_ELibrary.Data.User_Db", "Nguoitailen")
                        .WithMany("list_File_Tainguyen")
                        .HasForeignKey("Nguoitailen_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_filetainguyen_user");
            ...
            modelBuilder.Entity("LMS_ELibrary.Data.Tailieu_Baigiang_Db", b =>
                {
                    ...
                    b.Navigation("list_File_Baigiang");

                    b.Navigation("list_File_Tainguyen");
                });
